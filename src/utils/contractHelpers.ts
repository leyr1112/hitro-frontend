...
export const getBNBLotteryContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(BNBLotteryAbi, getBNBLotteryAddress(), signer)
}
