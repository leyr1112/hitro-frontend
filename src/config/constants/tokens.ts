...
export const HTO: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(
    ChainId.MAINNET,
    '0xB67A9caA00506F88B572298bd61eE92a9375844A',
    18,
    'HTO',
    'Hitro',
  ),
...
const tokens = {
  ...
  hto: {
    ...
    decimals: 9,
    projectLink: 'https://hitroswap.finance/'
  },
  babycake: {
    symbol: 'BABYCAKE',
    address: {
  ...
  vns: {
    symbol: 'VNS',
    address: {
      56: '0xD243F937f46660bB0eb0d440B7d19Fb5e64Bd7b3',
      97: '',
    },
    decimals: 18,
    projectLink: 'https://venusstake.finance/',
  },
  atom: {
    symbol: 'ATOM',
    address: {
