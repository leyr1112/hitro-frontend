...
import { Box, connectorLocalStorageKey, Flex, Heading, Skeleton } from '@pancakeswap/uikit'
...
const Hero: React.FC = () => {
  ...
  const getHeroHeading = () => {
      ...
      return (
        <>
          {prizeInBusd.isNaN() ? (
            ...
            <Balance color="text" fontSize="50px" bold prefix="$" value={prizeTotal} mb="8px" decimals={0} />
          )}
          <Heading mb="32px" scale="lg" color="textSubtle">
            {t('in prizes!')}
          </Heading>
        </>
      )
    ...
    return (
      <Heading mt="32px" scale="lg" color="textSubtle">
