    ...
    <Flex flexDirection="column">
      ...
      <>
        {isLoading || cakeAmount.isNaN() ? (
          ...
          <Balance fontSize="20px" bold unit=" BNB" value={getBalanceNumber(cakeAmount, 18)} decimals={3} />
        )}
        {isLoading || cakeAmount.isNaN() ? (
          <>
          ...
          <Balance
            ...
            color="textSubtle"
            prefix="~$"
            value={getBalanceNumber(cakeAmount.times(bnbBusdPrice))}
            decimals={0}
          />
        )}
          ...
          <>
            {numberWinners !== '0' && (
              <Text fontSize="12px" color="textSubtle">
                {getFullDisplayBalance(cakeAmount.div(parseInt(numberWinners, 10)), 18, 2)} BNB {t('each')}
              </Text>
            )}
            <Text fontSize="12px" color="textSubtle">
