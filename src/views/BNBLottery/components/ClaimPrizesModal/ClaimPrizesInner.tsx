...
import { fetchUserLotteries } from 'state/bnblottery'
import { useGasPrice } from 'state/user/hooks'
import { useAppDispatch } from 'state'
import Balance from 'components/Balance'
import { ToastDescriptionWithTx } from 'components/Toast'
import useToast from 'hooks/useToast'
import { useBNBLotteryContract } from 'hooks/useContract'
...
const ClaimInnerContainer: React.FC<ClaimInnerProps> = ({ onSuccess, roundsToClaim }) => {
  ...
  const dollarReward = cakeReward.times(bnbBusdPrice)
  const rewardAsBalance = getBalanceAmount(cakeReward, 18).toNumber()
  const dollarRewardAsBalance = getBalanceAmount(dollarReward, 18).toNumber()
