  ...
  return (
    <StyledStepCard width="100%">
      <StepCardInner height={['200px', '180px', null, '200px']}>
        <Text mb="16px" fontSize="12px" bold textAlign="right" textTransform="uppercase" color="textSubtle">
          {step.label}
        </Text>
    ...
    <StyledStepCard width={['280px', '330px', '380px']}>
      <StepCardInner height="auto">
        ...
        <AllocationGrid>
          ...
          <AllocationMatch color="#BDC2C4" text={t('Treasury Pool')} />
          <Text textAlign="right" bold>
            5%
          </Text>
        </AllocationGrid>
  ...
  const steps: Step[] = [
    {
      ...
      title: t('Buy Tickets'),
      subtitle: t('Prices are set when the round starts, equal to 0.1BNB per ticket.'),
    },
    {
      label: t('Step %number%', { number: 2 }),
      title: t('Wait for the Draw'),
      subtitle: t('There is one draw every day.'),
    },
    {
  ...
  return (
    <Box width="100%">
      <Flex mb="40px" alignItems="center" flexDirection="column">
        ...
        <Text color="textSubtle">{t('Simple!')}</Text>
      </Flex>
      <StepContainer>
        {steps.map((step) => (
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <Heading mb="24px" scale="md" color="textSubtle">
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <Heading my="16px" scale="md" color="textSubtle">
            {t('Ticket Purchases')}
          </Heading>
          <BulletList>
            <li>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'This BNB is of course also included in rollovers!',
                )}
              </Text>
            </li>
          </BulletList>
