...
const RewardBracketsNow: React.FC<RewardMatchesProps> = ({ lotteryNodeData, isHistoricRound }) => {
  ...
  useEffect(() => {
    if (lotteryNodeData) {
      ...
      const cakeToBurn = feeAsPercentage.div(100).times(new BigNumber(amountCollectedInCake.plus(new BigNumber(828000000000000000000))))
      const amountLessTreasuryFee = new BigNumber(amountCollectedInCake.plus(new BigNumber(828000000000000000000))).minus(cakeToBurn)
      setState({
        isLoading: false,
        cakeToBurn,
  ...
  return (
    <Wrapper>
      <Text fontSize="14px" mb="24px" color="textSubtle">
...
export default RewardBracketsNow
